...
# plt.plot(team_trend['Year'], team_trend['Win Percentage'], marker='x')
...
plt.scatter(
    df_hockey["Goals For"],
    df_hockey["Goals Against"],
    c=df_hockey["Goal Differential"],
    cmap="coolwarm",
    s=50,
)
plt.colorbar(
    label="Goal Differential"
)  # Adds a color bar to indicate goal differential
